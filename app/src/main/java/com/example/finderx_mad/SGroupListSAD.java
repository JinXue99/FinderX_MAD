...
public class SGroupListSAD {
    String TName,TM1,TM2,TM3,TM4,TM5;

    public SGroupListSAD(String TName,String TM1, String TM2, String TM3, String TM4, String TM5) {
        this.TName = TName;
        this.TM1 = TM1;
        this.TM2 = TM2;
        this.TM3 = TM3;
