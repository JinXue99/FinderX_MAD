...
public class SGroupListSADAdapter extends RecyclerView.Adapter<SGroupListSADAdapter.myviewHolder> {
    ...
    SGroupListSADAdapter(Context context, ArrayList<SGroupListSAD> list){
    ...
    @NonNull
    @Override
    public SGroupListSADAdapter.myviewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = inflater.inflate(R.layout.group_view_for_student, parent, false);
        return new SGroupListSADAdapter.myviewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull SGroupListSADAdapter.myviewHolder holder, int position) {
    ...
    public void filterList(ArrayList<SGroupListSAD> filteredList){
        list = filteredList;
